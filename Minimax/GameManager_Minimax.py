...
from PlayerAI_minimax import PlayerAI_minimax
...
class GameManager:
    ...
    def start(self):
        ...
        while not self.isGameOver() and not self.over and (self.maxAllowedTile == 0 or (self.maxAllowedTile > 0 and maxTile < self.maxAllowedTile)):
            ...
            turn = 1 - turn
            self.numOfMoves += 1
        f = open("Stats/output_minimax.txt", "a")
...
def PlayGame():
    ...
    playerAI  	= PlayerAI_minimax()
    # playerAI  	= PlayerAI_expectimax()
